...
trait Formats {
  ...
  implicit lazy val chargesSummaryJsonFormat: Format[ChargesSummaryJson] = format[ChargesSummaryJson]
  ...
  implicit lazy val rtiChargesJsonFormat: Format[RtiChargesJson] = format[RtiChargesJson]
